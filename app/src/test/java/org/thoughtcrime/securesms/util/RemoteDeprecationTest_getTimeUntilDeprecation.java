...
public class RemoteDeprecationTest_getTimeUntilDeprecation {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][]{
        ...
        { null, DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.0", null },

        // Truncated JSON (syntax error), no expiration
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"}", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Unquoted JSON key (syntax error), no expiration
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"}," +
          "  {minVersion: \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\" } ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.0", null },

        // Empty json, no expiration
        { "[]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.0", null },

        // Badly formatted minVersion, no expiration
        { "[ {\"minVersion\": \"1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Badly formatted date, no expiration
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"20-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Missing minVersion, no expiration
        { "[ {\"iso8601\": \"20-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Missing date, no expiration
        { "[ {\"minVersion\": \"1.1.1\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Missing expiration and date, no expiration
        { "[ {} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // Invalid inner object, no expiration
        { "[ { \"a\": 1 } ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // We meet the min version, no expiration
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.1", null },

        // We exceed the min version, no expiration
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.2", null },

        // We expire in 1 second
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:00Z"), "1.1.0", Duration.ofSeconds(1) },

        // We have already expired
        { "[ {\"minVersion\": \"1.1.1\", \"iso8601\": \"2020-01-01T00:00:01Z\"} ]", DateUtils.parseIso8601("2020-01-01T00:00:02Z"), "1.1.0", Duration.ofSeconds(-1) },
        ...
        { "[ {\"minVersion\": \"1.1\",   \"iso8601\": \"2020-01-01T00:00:01Z\"}," + // badly formatted minVersion
          ...
          DateUtils.parseIso8601("2020-12-01T00:00:00Z"), "1.1.0", Duration.ofSeconds(1) },
    });
  }
